  ...
  [@b.row]
    ...
    [@b.col title="负载" width="9%"]
      [#if profile.proxyEngine='haproxy']
        [@b.a href="/api/"+profile.qualifiedName+"/config/haproxy.cfg" target="_blank"]haproxy[/@]
      [#else]
        [@b.a href="/api/"+profile.qualifiedName+"/config/nginx.conf" target="_blank"]nginx[/@]
      [/#if]
    [/@]
    [@b.col title="配置" width="9%"]
      [@b.a href="/api/"+profile.qualifiedName+"/config/server.xml" target="_blank"]查看[/@]
    [/@]
  [/@]
[/@]
[@b.foot/]
