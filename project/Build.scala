...
object SasDepends {
  ...
  val webmvcVer = "0.9.12"
  val securityVer = "4.3.13"
  val idsVer = "0.3.12"
  val emsVer = "4.7.5"
  ...
  val appDepends = Seq(commonsCore, commonsFile, logback_classic, logback_core, scalatest, webAction, cdiApi, gson, HikariCP) ++
    ...
    Seq(postgresql, emsApp,webmvcSupport,webmvcView,serializerText,caffeine_jcache, hibernate_jcache)
}
