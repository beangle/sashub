...
object SasDepends {
  ...
  val beangle_data_model = "org.beangle.data" % "beangle-data-model" % "5.12.8"
  val beangle_data_hibernate = "org.beangle.data" % "beangle-data-hibernate" % "5.12.8"
  ...
  val beangle_bui_bootstrap = "org.beangle.bui" % "beangle-bui-bootstrap" % "0.9.2"
  val beangle_serializer = "org.beangle.serializer" % "beangle-serializer" % "0.1.28"
  val beangle_security = "org.beangle.security" % "beangle-security" % "4.5.1"
  ...
  val beangle_ems_app = "org.beangle.ems" % "beangle-ems-app" % "4.20.11"
